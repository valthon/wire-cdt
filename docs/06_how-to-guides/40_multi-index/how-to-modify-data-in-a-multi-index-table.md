...
If the `user` object you want to update is not found then raise an error message by using the [`sysio::check`](../../reference/Namespaces/namespacesysio#function-check) method.
